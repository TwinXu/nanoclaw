...
import { MediaAttachment } from './container-runner.js';
...
export class GroupQueue {
   ...
   */
  sendMessage(groupJid: string, text: string, media?: MediaAttachment[]): boolean {
    const state = this.getGroup(groupJid);
    ...
    try {
      ...
      const payload: { type: string; text: string; media?: MediaAttachment[] } = { type: 'message', text };
